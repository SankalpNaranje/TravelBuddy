...
export default function Suv(props) {
  ...
  return (
        ...
        <div className="modal fade" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog">
                ...
                <div className="modal-header">
                    <h1 className="modal-title fs-5" id="exampleModalLabel">Edit Bike Details</h1>
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div className="modal-body">
                <form>
                    <div className="mb-3">
                        <label htmlFor="title" className="form-label">Bike Name</label>
                    ...
                    <div className="mb-3">
                        <label htmlFor="tag" className="form-label">Photo</label>
    ...
    <div className="row my-3">
      <h2 style={{"textAlign":"center","font":"icon"}}>Bikes</h2>
      
      {notes.filter((note) => note.cartype === 'Bike').map((note) =>{
